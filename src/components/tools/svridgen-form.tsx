...
import { ConvertServerIDToAddress, ConvertToGameServerID } from "@/lib/losatools/svridgen";
...
const EncryptSvridForm = () => {
    ...
    return (
        <div>
            <form onSubmit={handleEncrypt} onReset={handleReset} className="flex flex-col gap-3">
                <div className="flex gap-4">
                    <Input value={ip} onChange={handleInputIP} placeholder="IP Address" />
                    <Input value={port} type="number" placeholder="Port" onChange={handleInputPort} />
                </div>
...
const DecrryptSvridForm = () => {
    ...
    return (
        <div>
            <form onSubmit={handleDecrypt} onReset={handleReset} className="flex flex-col gap-3">
